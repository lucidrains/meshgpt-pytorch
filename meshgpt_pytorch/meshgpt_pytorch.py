...
class MeshTransformer(Module):
    ...
    def forward_on_codes(
        ...
        if exists(cache):
            cached_attended_face_codes, coarse_cache, cached_attended_vertex_codes, fine_cache = cache
            cached_face_codes_len = cached_attended_face_codes.shape[-2]
            need_call_first_transformer = face_codes_len > cached_face_codes_len
        else:
            cached_attended_face_codes, coarse_cache, cached_attended_vertex_codes, fine_cache = (None, None, None, None)
