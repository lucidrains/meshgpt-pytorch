...
class MeshAutoencoder(Module):
    ...
    def encode(
        ...
        *,
        ...
        zeros_like_orig_face = lambda flattened_face_embed: torch.zeros(orig_face_embed_shape, device = device, dtype = face_embed.dtype).masked_scatter(rearrange(face_mask, '... -> ... 1'), flattened_face_embed)
        ...
        for maybe_attn, conv in self.encoders:
            ...
            if exists(maybe_attn) and False:
                face_embed = zeros_like_orig_face(face_embed)
